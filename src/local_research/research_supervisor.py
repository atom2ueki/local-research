"""Research supervisor for coordinating research across multiple specialized agents.
...
from local_research.prompts import supervisor_prompt
from local_research.research_agent import researcher_agent # later I will modify this to having mcp integrated
from local_research.state import (
    SupervisorState
)
from local_research.tools import (
    ConductResearch,
    ResearchComplete,
    think_tool
)
