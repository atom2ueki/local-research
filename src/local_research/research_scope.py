...
from local_research.prompts import clarify_with_user_instructions, transform_messages_into_research_topic_prompt
from local_research.state import AgentState, ClarifyWithUser, ResearchQuestion, AgentInputState
...
def clarify_with_user(state: AgentState) -> Command[Literal["write_research_brief", "__end__"]]:
    ...
    if response.need_clarification:
        return Command(
            goto=END, # this end means it will ask some questions to user, end and wait for users input
